...
//Middleware function takes in req, res, and next. Once the request has been sent and received a response, next allows it 
//go on to the next piece of middleware
